    ...
    protected function productsRows()
    {
        ...
        $rows = [
            ...
            'installment_price_3' => [
                'method' => 'priceRow',
                'data' => [
                    'display_name' => __('seeders.data_rows.installment_price') . ' - 3' ,
                    'browse' => 0,
                ],
            ],
            'installment_price_6' => [
                'method' => 'priceRow',
                'data' => [
                    'display_name' => __('seeders.data_rows.installment_price') . ' - 6' ,
                    'browse' => 0,
                ],
            ],
            'installment_price_12' => [
                'method' => 'priceRow',
                'data' => [
                    'display_name' => __('seeders.data_rows.installment_price') . ' - 12' ,
                    'browse' => 0,
                ],
            ],
            'price' => [
