...
class Publication extends Model
{
    ...
    public function typePage()
    {
        ...
        switch ($this->type) {
            ...
            case self::TYPE_NEWS: $pageSlug = 'news'; break;
        ...
        if ($pageId) {
            $page = Page::active()->withTranslation($locale)->findOrFail($pageId);
        } elseif ($pageSlug) {
            $page = Page::where('slug', $pageSlug)->active()->withTranslation($locale)->firstOrFail();
        }
        return $page;
    }
}
