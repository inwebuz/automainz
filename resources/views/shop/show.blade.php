...
@section('seo_title', $shop->getTranslatedAttribute('seo_title') ?: $shop->getTranslatedAttribute('name'))
@section('meta_description', $shop->getTranslatedAttribute('meta_description'))
@section('meta_keywords', $shop->getTranslatedAttribute('meta_keywords'))
        ...
        <div class="single-slider slider-height2 d-flex align-items-center" data-background="/images/bg/standard.jpg">
            <div class="container">
                <div class="hero-cap text-center">
                    <h1 class="main-header">{{ $shop->getTranslatedAttribute('name') }}</h1>
        ...
        <div class="container">
            <div class="media">
                ...
                <div class="media-body">
                    @if($shop->getTranslatedAttribute('description'))
                        <div class="contact-info-block mb-2">
                            {{ $shop->getTranslatedAttribute('description') }}
                        </div>
                    @endif
